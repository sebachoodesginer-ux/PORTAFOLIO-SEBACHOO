...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const projectInput =
        document.getElementById("contactProject");
    ...
    function detectCreativeMode() {
        ...
        const buttonActive =
            creativeButton?.getAttribute("aria-pressed") === "true";

        const bodyActive =
            body.classList.contains("creative-mode") ||
            body.classList.contains("creative-active") ||
            body.classList.contains("creative-mode-active") ||
            body.classList.contains("creative") ||
            body.classList.contains("modo-creativo");

        const htmlActive =
            html.classList.contains("creative-mode") ||
            html.classList.contains("creative-active") ||
            html.classList.contains("creative-mode-active") ||
            html.classList.contains("creative");
    ...
    function syncCreativeMode() {
        ...
        /*
           Solo modificamos si realmente cambió.
           Esto evita bucles innecesarios.
        */

        if (
            active &&
            !body.classList.contains("creative-on")
        ) {
            body.classList.add("creative-on");
        }
        ...
        if (
            ...
            body.classList.remove("creative-on");
        }
    }
    ...
    /* =====================================================
       OBSERVADOR MODO CREATIVO

       NO observamos body.class porque nosotros mismos
       añadimos creative-on a body y eso podría generar
       trabajo innecesario.
    ====================================================== */
    ...
    if (creativeButton) {
        ...
        creativeButton.addEventListener(
            ...
            () => {
                ...
                /*
                   main.js hace primero su trabajo.
                   Luego sincronizamos esta página.
                */
    ...
    const toastKicker =
        document.getElementById("contactToastKicker");

    const toastClose =
        document.getElementById("contactToastClose");
    ...
    const openCalendar =
        document.getElementById("openCalendarModal");
    ...
    /* =====================================================
       CREAR IFRAME SOLO CUANDO SE NECESITA
    ====================================================== */
    ...
    function createFrame(
        ...
        /*
           El modal aparece primero.
           Después cargamos Google.
        */
    ...
    function destroyFrame(container) {
    ...
    function openModal(modal) {
        ...
        /*
           Pausa las animaciones creativas
           mientras está abierto Google.
        */
    ...
    function isCreativeAnimatedButton(button) {
